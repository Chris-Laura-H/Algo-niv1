...
public class exo12corr { /* ATTENTION LA CLASSE DOIT AVOIR LE MÊME NOM QUE LE FICHIER ! */
    ...
    public static void main(String[] args) { /* Toujours le mettre pour tester votre code */
          ...
          pricereduc = price * (1-reduction/100.0);// Attention mettre 100,. pour définir le résulat en décimal sans arrondir
